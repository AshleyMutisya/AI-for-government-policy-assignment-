...
replicating Paper: A machine learning approach to predict ethnicity using personal name and census location in Canada
Link to paper: 
...
The reproduced code is the Ai for gov and policy project (1).py file
